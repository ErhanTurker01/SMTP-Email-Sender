...
class EmailSender:
    ...
    def sendmail_from_template(
        ...
        (if any). If in debug mode, the email details are logged rather than being sent. After processing all emails,
        the SMTP connection is closed using the finish() method.
